/*! htmx.org v2.0.10 (MIT, https://htmx.org) — vendored for boiler-snake's web admin console.
 *  Pinned + version-stamped per roadmap/web-admin.md §8.7 / §8.1-2 (no CDN, no build step).
 *  Source artifact: npm registry htmx.org@2.0.10 · dist/htmx.min.js (sha512-verified at
 *  vendor time). DO NOT EDIT this file — replace it wholesale on upgrade and bump the
 *  path in src/web/views/layout.js. */
